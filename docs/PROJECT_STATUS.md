...
Baseline auditada: `80b48c396d5882d2d3e1cd2e0f8f918a34842a26`, em `main` e `origin/main` na retomada. Alterações desta retomada são documentais.
...
- TTS aceita pedidos na fila, mas ainda não acompanha término/erro na interface. Ciclo de vida, cancelamento e disponibilidade de voz precisam do próximo recorte.
...
1. [TASK-010](../tasks/TASK-010.md): estabilizar TTS, resultados, cancelamento e ciclo de vida. Preparada, não despachada.
...
Nenhum executor ativo. Coordenação local exclusiva do Astra; implementadores externos via proprietário. Builds e testes pelo proprietário. Não criar agentes internos, repetir tarefas encerradas ou executar testes automaticamente.
